...
class DataIngestionConfig:
    ...
    feature_file_path:str = os.path.join(data_ingestion_dir,DATA_INGESTION_FEATURE_STORE_DIR,FILE_NAME)
...
class DataTransformationConfig:
    data_transformation_dir:str = os.path.join(trainingPipelineConfig.artifact_dir,DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR)
    ...
    transformed_test_file_path:str = os.path.join(data_transformation_dir,DATA_TRANSFORMATION_DIR_NAME,TEST_FILE_NAME.replace("csv","npy"))
...
class ModelTrainerConfig:
    ...
    model_configure_file_path:str = MODEL_TRAINER_MODEL_CONFIG_FILE_PATH
