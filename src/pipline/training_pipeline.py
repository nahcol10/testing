...
class TrainPipeline:
    ...
    def start_data_transformation(self,data_ingestion_artifact,data_validation_artifact) -> DataTransformationArtifact:
        try:
    ...
    def start_model_evaluation(self, data_ingestion_artifact: DataIngestionArtifact,
        ...
        """
        try:
            # Ensure the correct config is passed here
